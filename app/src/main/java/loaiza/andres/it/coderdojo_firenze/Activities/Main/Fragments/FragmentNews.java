...
import loaiza.andres.it.coderdojo_firenze.CustomControls.Twitter.TwitterAdapter;
import loaiza.andres.it.coderdojo_firenze.CustomControls.Twitter.TwitterListElement;
import loaiza.andres.it.coderdojo_firenze.Helpers.TwitterApiHelper;
import loaiza.andres.it.coderdojo_firenze.Networking.Twitter.AsyncTwitterRequest;
import loaiza.andres.it.coderdojo_firenze.Networking.Twitter.TwitterApi;
import loaiza.andres.it.coderdojo_firenze.Networking.Twitter.TwitterRequestListener;
...
public class FragmentNews extends Fragment implements TwitterRequestListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void populateList(RecyclerView listView, ArrayList<TwitterListElement> array) {
        if (this.getActivity() != null) {
            TwitterAdapter adapter = new TwitterAdapter(this.getActivity().getApplicationContext(), array);
